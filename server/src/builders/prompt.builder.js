...
3. If the CONTEXT does not contain enough information to answer confidently, you MUST refuse. Do not partially answer or speculate. Set "answer" to a safe fallback message and set "sufficientContext" to false.
4. Every factual claim in your answer must be backed by at least one citation referencing the exact chunk(s) it came from.
5. Do not cite a chunk unless you actually used it to produce the answer.
